...
<script type="text/javascript">window.onload = function() { Calendly.initBadgeWidget({ url: 'https://calendly.com/loizos', text: 'Schedule time with me', color: '#254753', textColor: '#ffffff', branding: true }); }</script>
